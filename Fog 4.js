...
function stat (){
 ...
 string = "=Countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!K2:K,"+'"'+d1.toString()+'"'+")"+
  "+ Countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!K2:K,"+'"'+d2.toString()+'"'+")"+
  "+Countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!K2:K,"+'"'+d3.toString()+'"'+")"+
 "+countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!T2:T,"+'"'+full.toString()+'"'+","+"IN!K2:K,"+'"'+d1.toString()+'"'+")"+
 "+countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!W2:W,"+'"'+full.toString()+'"'+","+"IN!K2:K,"+'"'+d1.toString()+'"'+")"+
 "+countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!Z2:Z,"+'"'+full.toString()+'"'+","+"IN!K2:K,"+'"'+d1.toString()+'"'+")"+
  "+countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!T2:T,"+'"'+full.toString()+'"'+","+"IN!K2:K,"+'"'+d2.toString()+'"'+")"+
 "+countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!W2:W,"+'"'+full.toString()+'"'+","+"IN!K2:K,"+'"'+d2.toString()+'"'+")"+
 "+countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!Z2:Z,"+'"'+full.toString()+'"'+","+"IN!K2:K,"+'"'+d2.toString()+'"'+")"+
  "+countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!T2:T,"+'"'+full.toString()+'"'+","+"IN!K2:K,"+'"'+d3.toString()+'"'+")"+
 "+countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!W2:W,"+'"'+full.toString()+'"'+","+"IN!K2:K,"+'"'+d3.toString()+'"'+")"+
 "+countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!Z2:Z,"+'"'+full.toString()+'"'+","+"IN!K2:K,"+'"'+d3.toString()+'"'+")";
 ...
 "+countifs(IN!I2:I,"+'"'+car.toString()+'"'+","+"IN!W2:W,"+'"'+full.toString()+'"'+")"+
 "+countifs(IN!I2:I,"+'"'+car.toString()+'"'+","+"IN!Z2:Z,"+'"'+full.toString()+'"'+")";
 Sheet4.getRange(19, 2).setFormula(string);
 
 
 //returning with bus on wednesday
  string = "=Countifs(IN!J2:J,"+'"'+bus.toString()+'"'+","+"IN!K2:K,"+'"'+d3.toString()+'"'+")"+
 "+countifs(IN!J2:J,"+'"'+bus.toString()+'"'+","+"IN!T2:T,"+'"'+full.toString()+'"'+","+"IN!K2:K,"+'"'+d3.toString()+'"'+")"+
 "+countifs(IN!J2:J,"+'"'+bus.toString()+'"'+","+"IN!W2:W,"+'"'+full.toString()+'"'+","+"IN!K2:K,"+'"'+d3.toString()+'"'+")"+
 "+countifs(IN!J2:J,"+'"'+bus.toString()+'"'+","+"IN!Z2:Z,"+'"'+full.toString()+'"'+","+"IN!K2:K,"+'"'+d3.toString()+'"'+")";
 Sheet4.getRange(20, 2).setFormula(string);
 
 //returning with bus on sunday
  string = "=Countifs(IN!J2:J,"+'"'+bus.toString()+'"'+","+"IN!K2:K,"+'"'+d1.toString()+'"'+")"+
 "+countifs(IN!J2:J,"+'"'+bus.toString()+'"'+","+"IN!T2:T,"+'"'+full.toString()+'"'+","+"IN!K2:K,"+'"'+d1.toString()+'"'+")"+
 "+countifs(IN!J2:J,"+'"'+bus.toString()+'"'+","+"IN!W2:W,"+'"'+full.toString()+'"'+","+"IN!K2:K,"+'"'+d1.toString()+'"'+")"+
 "+countifs(IN!J2:J,"+'"'+bus.toString()+'"'+","+"IN!Z2:Z,"+'"'+full.toString()+'"'+","+"IN!K2:K,"+'"'+d1.toString()+'"'+")";
 Sheet4.getRange(22, 2).setFormula(string);
 
  //Going with bus on Wednesday
 string = "=Countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!K2:K,"+'"'+d8.toString()+'"'+")"+
 "+countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!T2:T,"+'"'+full.toString()+'"'+","+"IN!K2:K,"+'"'+d8.toString()+'"'+")"+
 "+countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!W2:W,"+'"'+full.toString()+'"'+","+"IN!K2:K,"+'"'+d8.toString()+'"'+")"+
 "+countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!Z2:Z,"+'"'+full.toString()+'"'+","+"IN!K2:K,"+'"'+d8.toString()+'"'+")";
