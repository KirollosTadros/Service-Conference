  ...
  var bus= "اتوبيس";
  var car= "عربية";
  var sat="الجمعه, السبت";
  var sun= "الجمعه, السبت, الاحد";
  var Mon= "الجمعه, السبت, الاحد, الاتنين";
  var sun_mon= "الاحد, الاتنين";
  var sat_mon= "السبت, الاحد, الاتنين"
  var sat_sun= "السبت, الاحد"
  var Servant= "خادم";
  var Female= "خادمة";
...
function calculate (Sheet,row)
{
  ...
  return (1+child(Sheet,row))*(base+((Days)-3)*40)-50*(isCar(go)&&isCar(Come))*(1+isFull(Sheet,row));
}
...
function stat (){
  ...
  //Going with bus
 string = "=Countif(IN!H2:H,"+'"'+bus.toString()+'"'+")"+
 "+countifs(IN!H2:H,"+'"'+bus.toString()+'"'+","+"IN!W2:W,"+'"'+full.toString()+'"'+")"+
 "+countifs(IN!H2:H,"+'"'+bus.toString()+'"'+","+"IN!Z2:Z,"+'"'+full.toString()+'"'+")"+
 "+countifs(IN!H2:H,"+'"'+bus.toString()+'"'+","+"IN!AC2:AC,"+'"'+full.toString()+'"'+")";
 Sheet4.getRange(17, 2).setFormula(string);
 
   //Going with bus on satudary
   //3ashan 5ater Mariam
 string = "=Countifs(IN!H2:H,"+'"'+bus.toString()+'"'+","+"IN!G2:G,"+'"'+sat_sun.toString()+'"'+")"+
 "+countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!W2:W,"+'"'+full.toString()+'"'+","+"IN!G2:G,"+'"'+sat_sun.toString()+'"'+")"+
 "+countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!Z2:Z,"+'"'+full.toString()+'"'+","+"IN!G2:G,"+'"'+sat_sun.toString()+'"'+")"+
 "+countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!AC2:AC,"+'"'+full.toString()+'"'+","+"IN!G2:G,"+'"'+sat_sun.toString()+'"'+")"+
 "+Countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!G2:G,"+'"'+sat_mon.toString()+'"'+")"+
 "+countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!W2:W,"+'"'+full.toString()+'"'+","+"IN!G2:G,"+'"'+sat_mon.toString()+'"'+")"+
 "+countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!Z2:Z,"+'"'+full.toString()+'"'+","+"IN!G2:G,"+'"'+sat_mon.toString()+'"'+")"+
 "+countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!AC2:AC,"+'"'+full.toString()+'"'+","+"IN!G2:G,"+'"'+sat_mon.toString()+'"'+")";
 ...
 //returning with bus on saturday
  string = "=Countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!G2:G,"+'"'+sat.toString()+'"'+")"+
 "+countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!W2:W,"+'"'+full.toString()+'"'+","+"IN!G2:G,"+'"'+sat.toString()+'"'+")"+
 "+countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!Z2:Z,"+'"'+full.toString()+'"'+","+"IN!G2:G,"+'"'+sat.toString()+'"'+")"+
 "+countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!AC2:AC,"+'"'+full.toString()+'"'+","+"IN!G2:G,"+'"'+sat.toString()+'"'+")";
 Sheet4.getRange(19, 2).setFormula(string);
 
 //returning with bus on sunday
  string = "=Countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!G2:G,"+'"'+sun.toString()+'"'+")"+
 "+countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!W2:W,"+'"'+full.toString()+'"'+","+"IN!G2:G,"+'"'+sun.toString()+'"'+")"+
 "+countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!Z2:Z,"+'"'+full.toString()+'"'+","+"IN!G2:G,"+'"'+sun.toString()+'"'+")"+
 "+countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!AC2:AC,"+'"'+full.toString()+'"'+","+"IN!G2:G,"+'"'+sun.toString()+'"'+")";
 Sheet4.getRange(21, 2).setFormula(string);
 
  //returning with bus on Monday
  string = "=Countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!G2:G,"+'"'+Mon.toString()+'"'+")"+
 "+countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!W2:W,"+'"'+full.toString()+'"'+","+"IN!G2:G,"+'"'+Mon.toString()+'"'+")"+
 "+countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!Z2:Z,"+'"'+full.toString()+'"'+","+"IN!G2:G,"+'"'+Mon.toString()+'"'+")"+
 "+countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!AC2:AC,"+'"'+full.toString()+'"'+","+"IN!G2:G,"+'"'+Mon.toString()+'"'+")";
 Sheet4.getRange(22, 2).setFormula(string);
 
 //Total returing with bus
  string = "=Countif(IN!I2:I,"+'"'+bus.toString()+'"'+")"+
 "+countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!W2:W,"+'"'+full.toString()+'"'+")"+
 "+countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!Z2:Z,"+'"'+full.toString()+'"'+")"+
 "+countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!AC2:AC,"+'"'+full.toString()+'"'+")";
