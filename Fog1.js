...
function stat (){
 ...
 "+countifs(IN!I2:I,"+'"'+bus.toString()+'"'+","+"IN!T2:T,"+'"'+full.toString()+'"'+")"+
 ...
 //returning with bus on saturday
  string = "=Countifs(IN!J2:J,"+'"'+bus.toString()+'"'+","+"IN!K2:K,"+'"'+sat.toString()+'"'+")"+
 "+countifs(IN!J2:J,"+'"'+bus.toString()+'"'+","+"IN!T2:T,"+'"'+full.toString()+'"'+","+"IN!K2:K,"+'"'+sat.toString()+'"'+")"+
 "+countifs(IN!J2:J,"+'"'+bus.toString()+'"'+","+"IN!W2:W,"+'"'+full.toString()+'"'+","+"IN!K2:K,"+'"'+sat.toString()+'"'+")"+
 "+countifs(IN!J2:J,"+'"'+bus.toString()+'"'+","+"IN!Z2:Z,"+'"'+full.toString()+'"'+","+"IN!K2:K,"+'"'+sat.toString()+'"'+")";
 Sheet4.getRange(19, 2).setFormula(string);
 
 //returning with bus on sunday
  string = "=Countifs(IN!J2:J,"+'"'+bus.toString()+'"'+","+"IN!K2:K,"+'"'+sun.toString()+'"'+")"+
